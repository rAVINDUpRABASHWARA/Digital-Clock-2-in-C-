...
char d2[5][3] = {   127,127,127,
                    ' ',' ',127,
                    127,127,127,
                    127,' ',' ',
                    127,127,127 };

char d3[5][3] = {   127,127,127,
                    ' ',' ',127,
                    127,127,127,
                    ' ',' ',127,
                    127,127,127 };
...
char d5[5][3] = {   127,127,127,
                    127,' ',' ',
                    127,127,127,
                    ' ',' ',127,
                    127,127,127 };

char d6[5][3] = {   127,127,127,
                    127,' ',' ',
                    127,127,127,
                    127,' ',127,
                    127,127,127 };

char d7[5][3] = {   127,127,127,
                    ' ',' ',127,
                    ' ',' ',127,
                    ' ',' ',127,
                    ' ',' ',127 };

char d8[5][3] = {   127,127,127,
                    127,' ',127,
                    127,127,127,
                    127,' ',127,
                    127,127,127 };

char d9[5][3] = {   127,127,127,
                    127,' ',127,
                    127,127,127,
                    ' ',' ',127,
                    ' ',' ',127 };
...
void drawBorder(int x = 0, int y = 0){
    ...
    for( int i = 1; i <= height; i++ ){
        for( int j = 1; j <= width; j++ ){
            gotoxy(j+x, i+y);
            if( i == height && j == 1 ) cout << tl;
            else if( i == height && j == 1 ) cout << bl;
            else if( i == 1 && i == width ) cout << tr;
